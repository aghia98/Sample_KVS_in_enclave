...
static const char* KVS_method_names[] = {
  ...
  "/keyvaluestore.KVS/Get_blinded_share",
};
...
KVS::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_Get_blinded_share_(KVS_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status KVS::Stub::Store_polynomial_share(::grpc::ClientContext* context, const ::keyvaluestore::Id_with_polynomial& request, ::keyvaluestore::Value* response) {
  return ::grpc::internal::BlockingUnaryCall< ::keyvaluestore::Id_with_polynomial, ::keyvaluestore::Value, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_Store_polynomial_share_, context, request, response);
}

void KVS::Stub::async::Store_polynomial_share(::grpc::ClientContext* context, const ::keyvaluestore::Id_with_polynomial* request, ::keyvaluestore::Value* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::keyvaluestore::Id_with_polynomial, ::keyvaluestore::Value, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_Store_polynomial_share_, context, request, response, std::move(f));
}

void KVS::Stub::async::Store_polynomial_share(::grpc::ClientContext* context, const ::keyvaluestore::Id_with_polynomial* request, ::keyvaluestore::Value* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::keyvaluestore::Value>* KVS::Stub::PrepareAsyncStore_polynomial_shareRaw(::grpc::ClientContext* context, const ::keyvaluestore::Id_with_polynomial& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::keyvaluestore::Value, ::keyvaluestore::Id_with_polynomial, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_Store_polynomial_share_, context, request);
}

::grpc::ClientAsyncResponseReader< ::keyvaluestore::Value>* KVS::Stub::AsyncStore_polynomial_shareRaw(::grpc::ClientContext* context, const ::keyvaluestore::Id_with_polynomial& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status KVS::Stub::Get_blinded_share(::grpc::ClientContext* context, const ::keyvaluestore::Key& request, ::keyvaluestore::Value* response) {
  return ::grpc::internal::BlockingUnaryCall< ::keyvaluestore::Key, ::keyvaluestore::Value, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_Get_blinded_share_, context, request, response);
}

void KVS::Stub::async::Get_blinded_share(::grpc::ClientContext* context, const ::keyvaluestore::Key* request, ::keyvaluestore::Value* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::keyvaluestore::Key, ::keyvaluestore::Value, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_Get_blinded_share_, context, request, response, std::move(f));
}

void KVS::Stub::async::Get_blinded_share(::grpc::ClientContext* context, const ::keyvaluestore::Key* request, ::keyvaluestore::Value* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_Get_blinded_share_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::keyvaluestore::Value>* KVS::Stub::PrepareAsyncGet_blinded_shareRaw(::grpc::ClientContext* context, const ::keyvaluestore::Key& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::keyvaluestore::Value, ::keyvaluestore::Key, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_Get_blinded_share_, context, request);
}

::grpc::ClientAsyncResponseReader< ::keyvaluestore::Value>* KVS::Stub::AsyncGet_blinded_shareRaw(::grpc::ClientContext* context, const ::keyvaluestore::Key& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncGet_blinded_shareRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
KVS::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      KVS_method_names[5],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< KVS::Service, ::keyvaluestore::Id_with_polynomial, ::keyvaluestore::Value, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](KVS::Service* service,
             ::grpc::ServerContext* ctx,
             const ::keyvaluestore::Id_with_polynomial* req,
             ::keyvaluestore::Value* resp) {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< KVS::Service, ::keyvaluestore::Key, ::keyvaluestore::Value, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](KVS::Service* service,
             ...
             const ::keyvaluestore::Key* req,
             ::keyvaluestore::Value* resp) {
               return service->Get_blinded_share(ctx, req, resp);
             }, this)));
}
...
::grpc::Status KVS::Service::Store_polynomial_share(::grpc::ServerContext* context, const ::keyvaluestore::Id_with_polynomial* request, ::keyvaluestore::Value* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status KVS::Service::Get_blinded_share(::grpc::ServerContext* context, const ::keyvaluestore::Key* request, ::keyvaluestore::Value* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
